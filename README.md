...
│  │     ├─ mutations/
│  │     ├─ queries/
│  │     └─ route.ts                # GraphQL Yoga schema + resolvers
│  ├─ meet/
│  │  └─ [id]/
│  │     └─ heat/
│  │        └─ [heatId]/
│  │           └─ page.tsx          # Heat detail and live simulation view
│  │     └─ page.tsx                # Meet overview page
│  ├─ globals.css                   # Global Tailwind styles
│  ├─ layout.tsx                    # Root layout
│  ├─ not-found.tsx                 # 404 page
│  ├─ page.tsx                      # Home page
│  └─ providers.tsx                 # Apollo / UI context providers
├─ components/                      # UI components (HeatTable, etc.)
├─ data/                            # Mock data definitions
├─ hooks/                           # Custom React hooks (useHeatLanes, useStopwatch)
