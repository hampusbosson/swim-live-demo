...
// helper to persist global state between requests
...
if (!globalForMocks.mockMeets) {
  globalForMocks.mockMeets = [
    {
      id: "m1",
...
if (!globalForMocks.mockSessions) {
  globalForMocks.mockSessions = [
    {
      id: "s1",
      meetId: "m1",
      name: "Försökspass 1",
...
if (!globalForMocks.mockEvents) {
  globalForMocks.mockEvents = [
    {
      id: "e1",
      meetId: "m1",
      sessionId: "s1",
...
if (!globalForMocks.mockHeats) {
  globalForMocks.mockHeats = [
    {
      id: "h1",
      eventId: "e1",
      number: 1,
      startTime: "2025-03-15T09:15:00",
      startTimestamp: null,
    },
    {
      id: "h2",
    ...
    },
    {
      ...
      eventId: "e5",
      number: 1,
      startTime: "2025-04-05T10:15:00",
      startTimestamp: null,
    },
  ];
}

if (!globalForMocks.mockLanes) {
  globalForMocks.mockLanes = [
...
export const mockMeets = globalForMocks.mockMeets!;
export const mockSessions = globalForMocks.mockSessions!;
export const mockEvents = globalForMocks.mockEvents!;
export const mockHeats = globalForMocks.mockHeats!;
export const mockLanes = globalForMocks.mockLanes!;
